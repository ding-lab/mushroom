...
class EuclideanCodebook(nn.Module):
    ...
    def forward(
        ...
        return quantize, embed_ind, dist, unpacked_onehot
...
class VectorQuantize(nn.Module):
    ...
    def forward(
        ...
        quantize, embed_ind, distances, hots = self._codebook(x, **codebook_forward_kwargs)
        ...
        return quantize, embed_ind, loss, hots