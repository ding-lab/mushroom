...
from mushroom.model.sae_v2 import SAEargs
from mushroom.model.learners_v2 import SAELearner
...
class Mushroom(object):
    def __init__(
        ...
        self.recon_embs, self.recon_imgs, self.recon_embs_prequant, self.recon_cluster_ids, self.recon_cluster_probs = None, None, None, None, None
    ...
    def embed_sections(self):
        ...
        self.recon_imgs, self.recon_embs, self.recon_embs_prequant, self.recon_cluster_ids, self.recon_cluster_probs = self.learner.embed_sections()
